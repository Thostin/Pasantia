...
\textsl{Código fuente disponible en: \url{https://github.com/Thostin/Pasantia}}
...
El objetivo general de la pasantía desarrollada en la empresa NEXO~S.\nobreak\,A.,
  ...
  \begin{center}
	  \begin{tabular}{|c|l|}
		  ...
		  \multirow{4}{*}{PRESENTADO POR:} & NOMBRE Y APELLIDO DEL PASANTE:                                                \\ \cline{2-2}
		                                   & {\fontspec[Path=./]{0xProtoNerdFont-Regular.ttf} Ever Moisés Ortega Portillo} \\ \cline{2-2}
		                                   & FIRMA:                                                                        \\ \cline{2-2}
		                                   & \                                                                             \\
		  \hline

		  \multirow{8}{*}{APROBADO POR:}   & NOMBRE Y APELLIDO DEL TUTOR DE PASANTÍA:                                      \\ \cline{2-2}
		                                   & {\fontspec[Path=./]{0xProtoNerdFont-Regular.ttf} Osvaldo Bellassai}           \\ \cline{2-2}
		                                   & FIRMA:                                                                        \\ \cline{2-2}
		                                   & \                                                                             \\ \cline{2-2}
		                                   & Nombre y apellido del Director de la institución educativa:                   \\ \cline{2-2}
		                                   & {\fontspec[Path=./]{0xProtoNerdFont-Regular.ttf} Alcides Hosffmeister}        \\ \cline{2-2}
		                                   & FIRMA:                                                                        \\ \cline{2-2}
		                                   & \                                                                             \\ \hline
